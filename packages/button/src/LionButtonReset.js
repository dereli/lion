import { LionButtonBase } from './LionButtonBase.js';
 ...
 * the form.
 * Use LionButton when implicit form submission should be supported as well.
 *
 ...
 */
export class LionButtonReset extends LionButtonBase {
  constructor() {
    super();
    this.type = 'reset';
